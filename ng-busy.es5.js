...
var TrackerService = (function () {
    function TrackerService() {
        ...
        this.onCheckPending = new EventEmitter();
    }
    /**
     * @param {?} options
     * @return {?}
...
var BusyComponent = (function () {
    ...
    BusyComponent.ctorParameters = function () { return [
        { type: undefined, decorators: [{ type: Inject, args: ['busyConfig',] },] },
        { type: TrackerService, },
        { type: ChangeDetectorRef, },
    ]; };
    BusyComponent.propDecorators = {
        "busyContainer": [{ type: ViewChild, args: [BusyContainerDirective, { read: ElementRef },] },],
    };
...
var DefaultBusyComponent = (function () {
    ...
    DefaultBusyComponent.ctorParameters = function () { return [
        { type: undefined, decorators: [{ type: Inject, args: ['message',] },] },
        { type: ChangeDetectorRef, },
    ]; };
...
export { BusyComponent, BusyContainerDirective, BusyBackdropComponent, BusyDirective, BusyService, TrackerService, BusyConfig, BUSY_CONFIG_DEFAULTS, NgBusyModule, DefaultBusyComponent };
//# sourceMappingURL=ng-busy.es5.js.map
