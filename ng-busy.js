...
class BusyComponent {
     ...
     * @param {?} cdr
     */
    constructor(config, tracker, cdr) {
        this.config = config;
 ...
 * @suppress {checkTypes} checked by tsc
 */
const inactiveStyle$1 = style({
    opacity: 0
});
const timing$1 = '.3s ease';
...
function equals(o1, o2) {
    ...
    const /** @type {?} */ t1 = typeof o1;
    const /** @type {?} */ t2 = typeof o2;
    let /** @type {?} */ length;
    let /** @type {?} */ key;
    let /** @type {?} */ keySet;
    if (t1 === t2 && t1 === 'object') {
...
class BusyConfig {
     ...
     */
    constructor(config = {}) {
        for (const /** @type {?} */ option of Object.keys(BUSY_CONFIG_DEFAULTS)) {
...
class DefaultBusyComponent {
     ...
     */
    constructor(msg, _changeDetectionRef) {
        this.msg = msg;
...
class BusyDirective {
     ...
     * @param {?} renderer
     */
    constructor(service, tracker, resolver, vcr, element, injector, appRef, renderer) {
     ...
     */
    ngDoCheck() {
        const /** @type {?} */ options = this.optionsNorm = this.normalizeOptions(this.options);
     ...
     */
    createBackdrop() {
        const /** @type {?} */ backdropFactory = this.resolver.resolveComponentFactory(BusyBackdropComponent);
     ...
     */
    createBusy() {
        const /** @type {?} */ factory = this.resolver.resolveComponentFactory(BusyComponent);
    ...
    generateNgContent(injector) {
        if (typeof this.template === 'string') {
            const /** @type {?} */ element = this.renderer.createText(this.template);
            return [[element]];
        }
        if (this.template instanceof TemplateRef) {
            const /** @type {?} */ context = {};
            const /** @type {?} */ viewRef = this.template.createEmbeddedView(context);
            // In earlier versions, you may need to add this line
            // this.appRef.attachView(viewRef);
            return [viewRef.rootNodes];
        }
        // Else it's a component
        const /** @type {?} */ factory = this.resolver.resolveComponentFactory(this.template);
...
//# sourceMappingURL=ng-busy.js.map
