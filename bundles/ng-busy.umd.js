(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('rxjs/Subscription')) :
	typeof define === 'function' && define.amd ? define(['exports', '@angular/core', 'rxjs/Subscription'], factory) :
	(factory((global.ngBusy = global.ngBusy || {}),global.ng.core,global.Rx));
}(this, (function (exports,_angular_core,rxjs_Subscription) { 'use strict';
...
var TrackerService = (function () {
    function TrackerService() {
        ...
        this.onCheckPending = new _angular_core.EventEmitter();
    }
    /**
     * @param {?} options
     * @return {?}
     */
    TrackerService.prototype.reset = /**
     * @param {?} options
     * @return {?}
     */
    function (options) {
        ...
        if (options.minDuration) {
            this.durationPromise = setTimeout(function () {
                _this.durationPromise = undefined;
                if (_this.promiseList.length === 0) {
                    _this.onCheckPending.emit();
                }
     ...
     * @return {?}
     */
    TrackerService.prototype.isActive = /**
     * @return {?}
     */
    function () {
        var /** @type {?} */ result;
     ...
     * @return {?}
     */
    TrackerService.prototype.addPromise = /**
     * @param {?} promise
     * @return {?}
     */
    function (promise) {
     ...
     * @return {?}
     */
    TrackerService.prototype.finishPromise = /**
     * @param {?} promise
     * @return {?}
     */
    function (promise) {
        promise['busyFulfilled'] = true;
        var /** @type {?} */ index = this.promiseList.indexOf(promise);
        if (index === -1) {
            return;
        }
...
var BusyContainerDirective = (function () {
    function BusyContainerDirective() {
    }
    BusyContainerDirective.decorators = [
        { type: _angular_core.Directive, args: [{
                    selector: '[busy-container]'
                },] },
    ];
    return BusyContainerDirective;
}());
var BusyComponent = (function () {
    function BusyComponent(config, tracker, cdr) {
        var _this = this;
        this.config = config;
        this.tracker = tracker;
        this.cdr = cdr;
        this.sub = new rxjs_Subscription.Subscription();
    ...
    BusyComponent.ctorParameters = function () { return [
        { type: undefined, decorators: [{ type: _angular_core.Inject, args: ['busyConfig',] },] },
        { type: TrackerService, },
        { type: _angular_core.ChangeDetectorRef, },
    ]; };
    BusyComponent.propDecorators = {
        "busyContainer": [{ type: _angular_core.ViewChild, args: [BusyContainerDirective, { read: _angular_core.ElementRef },] },],
    };
...
var BusyBackdropComponent = (function () {
     ...
     * @return {?}
     */
    BusyBackdropComponent.prototype.isActive = /**
     * @return {?}
     */
    function () {
        return this.tracker.isActive();
        ...
        { type: _angular_core.Component, args: [{
                    ...
                    animations: [
                        trigger('fadeInOut', [
                            ...
                            transition('* => void', [
                                animate(timing$1, inactiveStyle$1)
                            ])
                        ])
                    ]
                },] },
...
function equals(o1, o2) {
    ...
    var /** @type {?} */ t1 = typeof o1;
    var /** @type {?} */ t2 = typeof o2;
    var /** @type {?} */ length;
    var /** @type {?} */ key;
    var /** @type {?} */ keySet;
    if (t1 === t2 && t1 === 'object') {
...
var BusyConfig = (function () {
    function BusyConfig(config) {
        ...
        for (var _i = 0, _a = Object.keys(BUSY_CONFIG_DEFAULTS); _i < _a.length; _i++) {
            var option = _a[_i];
...
var DefaultBusyComponent = (function () {
    function DefaultBusyComponent(msg, _changeDetectionRef) {
        this.msg = msg;
    ...
    DefaultBusyComponent.ctorParameters = function () { return [
        { type: undefined, decorators: [{ type: _angular_core.Inject, args: ['message',] },] },
        { type: _angular_core.ChangeDetectorRef, },
    ]; };
...
var BusyDirective = (function () {
    function BusyDirective(service, tracker, resolver, vcr, element, injector, appRef, renderer) {
        ...
        this.busyStart = new _angular_core.EventEmitter();
        this.busyStop = new _angular_core.EventEmitter();
     ...
     */
    function () {
        var /** @type {?} */ options = this.optionsNorm = this.normalizeOptions(this.options);
     ...
     * @return {?}
     */
    BusyDirective.prototype.ngOnDestroy = /**
     * @return {?}
     */
    function () {
        this.destroyComponents();
     ...
     * @return {?}
     */
    BusyDirective.prototype.normalizeOptions = /**
     * @param {?} options
     * @return {?}
     */
    function (options) {
     ...
     * @return {?}
     */
    BusyDirective.prototype.dectectOptionsChange = /**
     * @return {?}
     */
    function () {
     ...
     * @return {?}
     */
    BusyDirective.prototype.destroyComponents = /**
     * @return {?}
     */
    function () {
        if (this.busyRef) {
     ...
     * @return {?}
     */
    BusyDirective.prototype.createBackdrop = /**
     * @return {?}
     */
    function () {
        var /** @type {?} */ backdropFactory = this.resolver.resolveComponentFactory(BusyBackdropComponent);
        this.backdropRef = this.vcr.createComponent(backdropFactory, undefined, this.injector);
    };
    /**
     * @return {?}
     */
    BusyDirective.prototype.createBusy = /**
     * @return {?}
     */
    function () {
        var /** @type {?} */ factory = this.resolver.resolveComponentFactory(BusyComponent);
     ...
     * @return {?}
     */
    BusyDirective.prototype.generateNgContent = /**
     * @param {?} injector
     * @return {?}
     */
    function (injector) {
        if (typeof this.template === 'string') {
            var /** @type {?} */ element = this.renderer.createText(this.template);
            return [[element]];
        }
        if (this.template instanceof _angular_core.TemplateRef) {
            var /** @type {?} */ context = {};
            var /** @type {?} */ viewRef = this.template.createEmbeddedView(context);
            // In earlier versions, you may need to add this line
            // this.appRef.attachView(viewRef);
            return [viewRef.rootNodes];
        }
        // Else it's a component
        var /** @type {?} */ factory = this.resolver.resolveComponentFactory(this.template);
    ...
    BusyDirective.propDecorators = {
        ...
        "busyStart": [{ type: _angular_core.Output },],
        "busyStop": [{ type: _angular_core.Output },],
    };
...
exports.BusyContainerDirective = BusyContainerDirective;
...
//# sourceMappingURL=ng-busy.umd.js.map
